...
execute if score happyghast+ happy.settings.flying_speed matches 11 as @s unless predicate happy:player_flying unless predicate happy:anchor run attribute @s flying_speed base set 0.05
